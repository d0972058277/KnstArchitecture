...
using KnstApiMySql.Models.Test;
using KnstApiMySql.Queries.Example;
using KnstApiMySql.Repos.Example;
using KnstApiMySql.Services.Example;
...
namespace KnstApiMySql.Controllers
{
    ...
    public class ExampleController : ControllerBase
    {
        ...
        public ExampleController(IMySqlUnitOfWork unitOfWork, IExampleQuery exampleQuery, IExampleService exampleService)
        {
